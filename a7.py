...
class BayesClassifier:
    ...
    def train(self) -> None:
        ...
        # test your code with neutral reviews)
            ...
            is_positive = filename.startswith(self.pos_file_prefix)
            tokenized = self.tokenize(text)
            self.update_dict(tokenized, self.pos_freqs if is_positive else self.neg_freqs)
    ...
    def classify(self, text: str) -> str:
        ...
        for word in tokenized:
            if word in self.pos_freqs:
                positive_probability += math.log(self.pos_freqs[word] / len(self.pos_freqs), math.e)

            if word in self.neg_freqs:
                negative_probability += math.log(self.neg_freqs[word] / len(self.neg_freqs), math.e)
        ...
        # larger)
        output = "positive" if positive_probability > negative_probability else "negative"
